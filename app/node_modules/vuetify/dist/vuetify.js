...
(function (global, factory) {
    ...
    setup(props, _ref) {
      ...
      return () => {
        ...
        return (_slots$default = (_slots$default2 = slots.default) == null ? void 0 : _slots$default2.call(slots)) != null ? _slots$default : (_props$items = props.items) == null ? void 0 : _props$items.map(_ref2 => {
          ...
          }) : slots.item ? slots.item(itemProps) : vue.createVNode(VListItem, itemProps, slots);
        });
      };
    }
  ...
  const VList = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const items = vue.computed(() => parseItems$1(props.items));
      const {
        themeClasses
      } = provideTheme(props);
      const {
  ...
  const VSelect = genericComponent()({
    ...
    setup(props, _ref2) {
      ...
      vue.watch(() => vTextFieldRef.value, val => {
  ...
  function useFilter(props, items, query) {
    ...
    const filteredItems = vue.computed(() => {
      return filterItems(vue.unref(items), strQuery.value, {
      ...
      return () => {
        ...
        return vue.createVNode(props.tag, vue.mergeProps({
          ...
          default: () => [vue.createVNode("div", {
            ...
            }, [content])]), [[vue.vShow, props.modelValue]])]
          })])]
        });
      };
    }
  ...
  const version = "3.0.0-next-20220508.0";
