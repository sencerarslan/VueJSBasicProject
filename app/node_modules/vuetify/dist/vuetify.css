...
.v-app-bar.v-toolbar:not(.v-toolbar--flat) {
  ...
  grid-template-columns: -webkit-max-content auto -webkit-max-content -webkit-min-content;
...
.v-tabs.v-slide-group--vertical .v-tab {
  --v-btn-height: 48px;
}
...
.v-slider.v-input--horizontal .v-slider-track__tick {
  -webkit-margin-before: calc(var(--v-slider-track-size) / 2 + 1px);
...
.v-slider.v-input--vertical .v-slider-track__tick {
  -webkit-margin-start: calc(var(--v-slider-track-size) / 2 + 1px);
...
.v-slider.v-input--vertical .v-slider-track__tick .v-slider-track__tick-label {
  -webkit-margin-start: calc(var(--v-slider-track-size) + 20px);
